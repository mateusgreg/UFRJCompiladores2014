...
L_for_cond_5:
  ...
  temp_int_22 = a[temp_int_17] * b[temp_int_20];
  temp_int_23 = soma + temp_int_22;
  soma = temp_int_23;
...
L_for_cond_8:
  ...
  printf( "%s", "] = " );
  temp_int_29 = i * 4;
  temp_int_30 = temp_int_29 + j;
  printf( "%d", a[temp_int_30] );
  printf( "%s", "   " );
  temp_int_28 = j + 1;
  j = temp_int_28;
  goto L_for_cond_8;
...
L_for_cond_12:
  ...
  printf( "%s", "] = " );
  temp_int_39 = i * 10;
  temp_int_40 = temp_int_39 + j;
  printf( "%d", c[temp_int_40] );
  printf( "%s", "   " );
  temp_int_38 = j + 1;
  j = temp_int_38;
  goto L_for_cond_12;
